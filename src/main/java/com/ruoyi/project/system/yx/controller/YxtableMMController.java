...
public class YxtableMMController extends BaseController
{
    ...
    @Autowired
    private ItableMMService tableMMService;
    ...
    public Map<String,Object> tableDDCount(YxYue YxYue) {
  	    ...
  	    Map<String,Object> map = new HashMap<>();
  	    		...
  	    		YxYue.setWorkClass("一线工资");
  	  	    	Map dataj1p = tableMMService.YxtableMMPre(YxYue);
  	    		...
  	    		YxYue.setWorkClass("二线工资");
  	  	    	Map dataj2p = tableMMService.YxtableMMPre(YxYue);
				...
				BigDecimal userSumj2p =	BigDecimal.ZERO;
  	    		...
  	    		YxYue.setWorkClass("三线工资");
  	  	    	Map dataj3p = tableMMService.YxtableMMPre(YxYue);
	    		...
	    		map.put("userSumj2p",userSumj2p);
  	    		...
  	    		YxYue.setWorkType("月件工资");
  	    		YxYue.setWorkClass("一线工资");
  	  	    	Map datay1p = tableMMService.YxtableMMPre(YxYue);
  	    		...
  	    		YxYue.setWorkClass("二线工资");
  	  	    	Map datay2p = tableMMService.YxtableMMPre(YxYue);
				...
				BigDecimal userSumy2p =	BigDecimal.ZERO;
  	    		...
  	    		YxYue.setWorkClass("三线工资");
  	  	    	Map datay3p = tableMMService.YxtableMMPre(YxYue);
				...
				BigDecimal userSumy3p =	BigDecimal.ZERO;
  	    		...
  	    		YxYue.setWorkType("计件工资");
  	    		YxYue.setWorkClass("一线工资");
  	  	    	Map dataj1 = tableMMService.YxtableMM(YxYue);
  	    		...
  	    		YxYue.setWorkClass("二线工资");
  	  	    	Map dataj2 = tableMMService.YxtableMM(YxYue);
  	    		...
  	    		YxYue.setWorkClass("三线工资");
  	  	    	Map dataj3 = tableMMService.YxtableMM(YxYue);
  	    		...
  	    		YxYue.setWorkType("月薪工资");
  	    		YxYue.setWorkClass("一线工资");
  	  	    	Map datay1 = tableMMService.YxtableMM(YxYue);
  	    		...
  	    		YxYue.setWorkClass("二线工资");
  	  	    	Map datay2 = tableMMService.YxtableMM(YxYue);
  	    		...
  	    		YxYue.setWorkClass("三线工资");
  	  	    	Map datay3 = tableMMService.YxtableMM(YxYue);
