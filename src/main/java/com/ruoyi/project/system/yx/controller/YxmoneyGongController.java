 ...
 */
@Controller
@RequestMapping("/system/yx/moneyGong")
public class YxmoneyGongController extends BaseController
{
    private String prefix = "system/yx/moneyGong";

    @Autowired
    private IYxService yxService;

    @RequiresPermissions("system:yx:moneyGong:view")
    @GetMapping()
    public String yxMoneyGong()
    {
        return prefix + "/yx";
    }
     ...
     * 导出牙星公司列表
     */
    @RequiresPermissions("system:yx:moneyGong:export")
